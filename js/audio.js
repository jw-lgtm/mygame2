(function () {
  ...
  const TRACKS = {
    ...
    tension: {
      ...
      wave: "square",
      padWave: "sawtooth",
      pad: [82.41, 123.47, 174.61],
      scale: [174.61, 185, 207.65, 246.94, 277.18, 329.63],
      pattern: [0, 0, 2, 1, 4, 3, 1, 0],
      padGain: 0.026,
      noteGain: 0.042,
      drum: true,
      noise: true
    ...
    madness: {
      ...
      wave: "sawtooth",
      padWave: "square",
      pad: [73.42, 92.5, 138.59],
      scale: [146.83, 155.56, 174.61, 207.65, 233.08, 277.18],
      pattern: [0, 5, 1, 4, 2, 3, 1, 5],
      padGain: 0.022,
      noteGain: 0.038,
      drum: true,
      noise: true
